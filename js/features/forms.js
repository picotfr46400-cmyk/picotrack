...
function toggleActive(id){
  ...
  document.getElementById('prod-forms-count').textContent=FORMS_DATA.filter(f=>f.actif!==false && f.published===true).length;
...
function renderProdForms(list){
  const actifs=(list||[]).filter(f=>f && f.actif!==false && f.published===true);
